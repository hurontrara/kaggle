...
from data_loader import TextClassificationDataset, TextClassificationCollator
...
def define_argparser():
    ...
    p.add_argument('--train_fn', required=True) # train_data
    ...
    p.add_argument('--adam_epsilon', type=float, default=1e-4)
...
def main(config):
    ...
    n_total_iterations = len(train_loader) * config.batch_size
